...
// place rune clues in the SAME chamber (MUST succeed)
const ok = placeRuneCluesInChamber(map, chamber, combo, spot.x, spot.y);
if (!ok) {
  // undo chest and try again
  map.objects[spot.y][spot.x] = null;
  continue;
}
