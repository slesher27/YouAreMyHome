...
// If the user has ever set the checkbox manually, respect that.
// Otherwise default: unchecked after you've seen the tutorial once.
const savedWant = loadWantTutorial();
state.wantTutorial = (savedWant !== null) ? savedWant : !state.tutorial.seen;
...
if (!state.tutorial.seen && state.wantTutorial) {
