...
// Multiplayer-only: world comes from server snapshot.
// Placeholders so nothing crashes before first snapshot arrives.
state.world = state.world || { tiles: [], objects: [], meta: { w: 0, h: 0 } };
