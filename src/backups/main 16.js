...
if (obj && explored) {
  ...
  // If holding hands: hide both players and draw ONE combined icon between them
  if (hh) {
    ...
    if (mx >= camX && mx < camX + viewW && my >= camY && my < camY + viewH) {
